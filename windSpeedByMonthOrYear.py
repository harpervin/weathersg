...
def plotweatherByMonth(title:str, measurement: str, year, month, output_file, weather_type: str, data_format: str):
    # Store and fetch monthly weather data
    monthly_weather = store_daily_weather(year, month, output_file, weather_type, data_format)
...
def plotweatherByYear(title:str, measurement: str, year, output_file, weather_type, data_format):
    # Fetch yearly weather data
    yearly_weather = {}
    for month in range(1, 13):
        monthly_data = store_daily_weather(year, month, output_file, weather_type, data_format)
        average_weather = sum(monthly_data.values()) / \
...
if __name__ == '__main__':
    ...
    #plotweatherByYear(2024, "daily_total_windspeed_data.json", "wind-speed", "total")
    ...
    #plotweatherByYear(2024, "daily_average_windspeed_data.json", "wind-speed", "average")
