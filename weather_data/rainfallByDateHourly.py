...
from helper_functions import import_dictionaries, getTotalDataHourly, sumValuesForEveryEntry
...
if __name__ == "__main__":
    ...
    aggregated_rainfall_data = sumValuesForEveryEntry(hourly_rainfall_data, defaultdict(float))
    formatted_rainfall_data = convert_to_datetime(aggregated_rainfall_data)
